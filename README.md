...
![Image](https://img.shields.io/badge/Engine-Three.js-blueviolet)
![Image](https://img.shields.io/badge/AI-Google_Gemini-blue)
![Image](https://img.shields.io/badge/Infrastructure-AWS_Level_3-orange)
⚔️ Project Overview
...
Terraform: Provisions the EC2 instance, Security Groups (Port 80/22), and S3 Remote State.
Ansible: Configures the Nginx web server and clones this repository.
User Data: Automatically bootstraps the environment for an instant "Push-to-Live" experience.
⚙️ Setup & API Key
To enable the full AI experience:
Obtain a free API Key from Google AI Studio.
In the game Main Menu, click GenAI Settings.
Paste your key. It is saved locally in your browser's localStorage.
Obtain a free API Key from Google AI Studio.
In the game Main Menu, click GenAI Settings.
Paste your key. It is saved locally in your browser's localStorage.
